    ...
    <div className="space-y-8 pb-8">
      ...
      <div>
        ...
        <p className="text-lg text-gray-600 mt-3">
          Practice with a realistic, timed aptitude test. Get immediate feedback and AI-generated tips to improve.
        </p>
      </div>
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex gap-3 text-lg">
                ...
                <span className="text-gray-700"><strong>10 questions</strong> on quantitative reasoning and logic</span>
              </li>
              <li className="flex gap-3 text-lg">
                <span className="text-indigo-600 font-bold flex-shrink-0">✓</span>
                <span className="text-gray-700"><strong>10 minutes</strong> total time with live countdown</span>
              </li>
              <li className="flex gap-3 text-lg">
                <span className="text-indigo-600 font-bold flex-shrink-0">✓</span>
                <span className="text-gray-700"><strong>Camera & microphone</strong> for proctored experience</span>
              </li>
              <li className="flex gap-3 text-lg">
                <span className="text-indigo-600 font-bold flex-shrink-0">✓</span>
                <span className="text-gray-700"><strong>Instant results</strong> with AI-generated tips</span>
              </li>
            </ul>

            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
              <p className="text-sm text-blue-900">
                <strong>Note:</strong> Your camera and microphone will be used for preview only—no recording takes place. This creates a realistic test environment.
              </p>
            </div>
